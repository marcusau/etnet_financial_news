...
from transformers import BertPreTrainedModel, BertModel,ElectraForPreTraining,ElectraModel
...
class Electra_BiLSTM_CRF(ElectraForPreTraining):
    ...
    def forward(self, input_ids, tags, token_type_ids=None, input_mask=None):
        ...
        emissions = self.tag_outputs(input_ids, token_type_ids, input_mask,output_hidden_states=True)
        ####bert_outputs = self.bert_model(input_ids=x[0],    attention_mask=x[1], token_type_ids=x[2],  output_hidden_states=True)
    ...
    def tag_outputs(self, input_ids, token_type_ids=None, input_mask=None):
        ...
        outputs = self.electra(input_ids, token_type_ids=token_type_ids, attention_mask=input_mask )#,output_hidden_states=Tru
